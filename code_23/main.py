...
from direction_law import *
from speed_law import *
from MA import *
    ...
    if setup == 1:
        ...
        for scan in lidar.iter_scans() : 
            ...
            if go == 1:
                ...
                cyclerate_dir, angle_cible = Direction_Law(cone_detect,environnement,mapt,ALPHA,THETA)
                ...
                cyclerate_prop, dfront = Speed_Law(mapt,D,D_VAL,speed_strategy,v_cste,vmin,vmax,angle_cible,inv_alpha0)
                ...
                GENERAL_LIST = [t, dfront, cyclerate_prop, angle_cible, cyclerate_dir]
